...
export function AnalyzeChat() {
    ...
    React.useEffect(() => {
        axios.get(`https://tender-plum-tuna.cyclic.app/v1/api/tickets/${localStorage.getItem('ticket')}`, {
            headers: {
    ...
    const sendMessage = () => {
        setMessage("");
        const url = 'https://nice-gold-oyster-slip.cyclic.app/api/v1/tickets/message';
    ...
    return (
        <>
            ...
            <div style={{position: "relative", height: "calc(100vh - 192px)", direction: "initial"}}>
